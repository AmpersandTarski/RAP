...
List of activities to get a new developer up-to speed with RAP development.
 ...
 - Schedule a meeting with [Stef Joosten]<a href="mailto:Stef.Joosten@ordina.nl?subject=Request demo meeting">test email text</a> to get an explanation and demo about the Ampersant project.
