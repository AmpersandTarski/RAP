...
5. In your browser, navigate to your hostname, e.g. `localhost`. You should now see this:
   ![install the database](https://github.com/AmpersandTarski/RAP/blob/main/RAP%20reinstall%20application%202020-11-02.png?raw=true)
...
7. In your browser, click on Home or navigate to your hostname, e.g. http://localhost.
   ...
   ![landing page](https://github.com/AmpersandTarski/RAP/blob/main/RAP%20landing%20page%202020-11-02.png)
