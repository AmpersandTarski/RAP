 ...
 */
ExecEngine::registerFunction('SetToday', function ($relation, $srcConcept, $srcAtom, $dateConcept) {
    /** @var \Ampersand\Rule\ExecEngine $this the ExecEngine instance is bound to this closure */
    ExecEngine::getFunction('InsPair')->call($this, $relation, $srcConcept, $srcAtom, $dateConcept, date('d-m-Y G:i:s T'));
});
